...
const live2d_path = "https://fastly.jsdelivr.net/gh/oivio-up/live2d-widget@1.2.7/dist/";
...
if (screen.width >= 768) {
    Promise.all([
        ...
        initWidget({
            ...
            cdnPath: "https://fastly.jsdelivr.net/gh/oivio-up/live2d-widget@1.2.7/model/",
